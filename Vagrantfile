...
# PHP Options
php_version           = "distributed" # Options: latest|previous|distributed   For 12.04. latest=5.5, previous=5.4, distributed=5.3
...
public_folder         = "/vagrant/www/public" # If installing Symfony or Laravel, leave this blank to default to the framework public directory
...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "wp-dev-53.dev"
